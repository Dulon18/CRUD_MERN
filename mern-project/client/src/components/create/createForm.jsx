...
import Create from "../common/AppNavbar";
...
const createForm = () => {
     ...
     const SaveButton = () => {
          ...
          {
               Create(Student_firstName, Student_lastName, Student_gender,
     ...
     return (
          <div className='container'>
               <div className="row">
                    ...
                    <div className="col-4">
                         <button onClick={SaveButton} type="button" className='btn btn-info'>Save</button>
                    </div>
               </div>
